...
int main(){
    ...
    minurbs::RationalCurve<double> crv(2, K, CP, W);
    ...
    // cout << left << setw(10) << "para" << setw(25) << "dx" << setw(25) << "dy"<< endl;
    // for(int i = 0; i <= 10; i++){
    //     VectorXd p = curveTangent(crv, 0.1 * i);
    //     cout << left << setw(10) << setprecision(2) << fixed << 0.1*i
    //          << setw(25) << setprecision(16) << p(0)
    //          << setw(25) << setprecision(16) << p(1) << endl;
    // }
